...
│   ├── data_parser.py      # JSON/CSV/PDF parsing
│   ├── transaction_categorizer.py  # Transaction categorization
│   ├── financial_calculator.py     # Financial metrics
...
> ⚠️ Obtain a Gemini API key from [Google AI Studio](https://makersuite.google.com/). Credit scoring, policy matching, and explainability agents require it.
...
┌─────────────────────────────────────────────────────────────┐
│                    Tool Functions                            │
│  • Data Parsing  • Categorization  • Calculations           │
...
│  • Financial Health  • Behavioral Score                     │
│  • Product Recommendations  • Explainability                │
└─────────────────────────────────────────────────────────────┘
```

---

**Built with ❤️ for MSME Credit Intelligence**
