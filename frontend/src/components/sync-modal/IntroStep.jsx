...
const IntroStep = ({ setStep }) => {
  return (
    <div className="text-center space-y-6 animate-fade-in py-4">
      ...
      <div>
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Secure Data Synchronization</h2>
        <p className="text-gray-600 dark:text-gray-400 max-w-md mx-auto">
          We use the RBI-approved <span className="text-blue-600 dark:text-blue-400 font-semibold">Account Aggregator (AA)</span> framework.
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-left max-w-lg mx-auto mt-8">
        {[
          ...
          <div key={i} className="p-4 rounded-xl bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700/50">
