...
const MobileStep = ({ mobile, setMobile, handleMobileSubmit }) => {
  return (
    <div className="max-w-md mx-auto pt-10 animate-fade-in">
      <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Verify Identity</h2>
      ...
      <form onSubmit={handleMobileSubmit} className="space-y-6">
        <div>
          <label className="text-sm font-medium text-gray-700 dark:text-gray-300 block mb-2">Mobile Number</label>
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-gray-50 dark:bg-[#15161c] border border-gray-200 dark:border-gray-700 rounded-xl py-3 pl-10 pr-4 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all font-mono text-lg"
              autoFocus
            />
          </div>
